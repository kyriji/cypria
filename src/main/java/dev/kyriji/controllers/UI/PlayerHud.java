...
public class PlayerHud extends CustomUIHud {
	...
	private void update() {
		...
		builder.set("#Row1.TextSpans", Message.raw("Kills: ").color(Color.WHITE).insert(Message.raw(String.valueOf(pitPlayer.kills)).color(Color.GREEN)));
		builder.set("#Row2.TextSpans", Message.raw("Deaths: ").color(Color.WHITE).insert(Message.raw(String.valueOf(pitPlayer.deaths)).color(Color.RED)));
		builder.set("#Row3.TextSpans", Message.raw("Streak: ").color(Color.WHITE).insert(Message.raw(String.valueOf(pitPlayer.currentStreak)).color(Color.YELLOW)));
		builder.set("#Row4.TextSpans", Message.raw("Gold: ").color(Color.WHITE).insert(Message.raw(String.valueOf(pitPlayer.gold)).color(ColorUtils.GOLD)));
